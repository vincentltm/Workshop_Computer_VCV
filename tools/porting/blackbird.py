...
def post_process(content, src_rel):
    if src_rel == "main.cpp":
        ...
        content = content.replace('extern const unsigned char clock[];', 'extern "C" const unsigned char crow_lua_clock_data[];')
        content = content.replace('extern const unsigned int clock_len;', 'extern "C" const unsigned int crow_lua_clock_data_len;')
