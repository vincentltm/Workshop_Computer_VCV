def post_process(src_content, src_rel):
    # Rename C++ reserved operator keywords and, or, not, xor, pow
    ...
    src_content = src_content.replace("static int pow(int a, int b)", "static int op_pow(int a, int b)")
    ...
    src_content = src_content.replace("s->function = pow;", "s->function = (const void*)op_pow;")
    ...
    src_content = src_content.replace("ret->function = t;", "ret->function = (const void*)t;")
    ...
    src_content = src_content.replace("#define M(e) te_eval(n->parameters[e])", "#define M(e) te_eval((const te_expr*)n->parameters[e])")
